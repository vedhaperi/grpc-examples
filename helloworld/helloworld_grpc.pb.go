...
func (c *greeterClient) CheckHeartbeat(ctx context.Context, in *BeatRequest, opts ...grpc.CallOption) (*BeatReply, error) {
	out := new(BeatReply)
	err := c.cc.Invoke(ctx, "/helloworld.Greeter/CheckHeartbeat", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_CheckHeartbeat_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(BeatRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GreeterServer).CheckHeartbeat(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/helloworld.Greeter/CheckHeartbeat",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GreeterServer).CheckHeartbeat(ctx, req.(*BeatRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Greeter_SendBackup_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	if interceptor == nil {
		return srv.(GreeterServer).SendBackup(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var Greeter_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Greeter_CheckHeartbeat_Handler,
		},
		{
			MethodName: "SendBackup",
			Handler:    _Greeter_SendBackup_Handler,
		},
	},
